...
async def test_image_aquery(image_evaluator):
    ...
    query_response = await aquery(fn_name=fn_name, images_input=[
...
async def test_text_and_image_aquery(text_and_image_evaluator):
    ...
    query_response = await aquery(
        ...
        images_input=["https://i.ytimg.com/vi/cblHUeq3bkE/hq720.jpg?sqp=-oaymwEhCK4FEIIDSFryq4qpAxMIARUAAAAAGAElAADIQj0AgKJD&rs=AOn4CLAKn3piY91QRCBzRgnzAPf7MPrjDQ"]
    )
